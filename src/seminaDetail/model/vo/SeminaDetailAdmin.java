...
public class SeminaDetailAdmin  implements Serializable {
	...
	public SeminaDetailAdmin() {
		
	}


	public SeminaDetailAdmin(int seminaDetailNo, int seminaNo, int userNo, Date seminaDetailDate, String seminaState,
	...
	public String toString() {
		return "SeminaDetailAdmin [seminaDetailNo=" + seminaDetailNo + ", seminaNo=" + seminaNo + ", userNo=" + userNo
