 ...
 */
@WebServlet("/teachlogofteacher2")
public class LearnLogofStudentByTeacher2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LearnLogofStudentByTeacher2() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Learnlogforinfo> onlesson = new LearnLogService().getlessonLog4_1(user);
