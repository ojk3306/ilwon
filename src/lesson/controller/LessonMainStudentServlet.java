...
/**
 * Servlet implementation class LessonMainStudentServlet
 */
@WebServlet("/lmstudent")
public class LessonMainStudentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LessonMainStudentServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Lesson> list = new LessonService().selectMainStudent();				
		System.out.println("StudentList : " + list + " / (To.LessonMainStudentServlet)");
