...
/**
 * Servlet implementation class LessonListServlet
 */
@WebServlet("/lrlist")
public class LessonReadyListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LessonReadyListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Lesson> list = new LessonService().selectLessonList();				
