...
/**
 * Servlet implementation class LearnReadyListServlet
 */
@WebServlet("/llrlist")
public class LearnReadyListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LearnReadyListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//리스트 결과를 json 배열에 담아서, 전송하는 컨트롤러				
				ArrayList<Lesson> list = new LessonService().selectLearnList();				
