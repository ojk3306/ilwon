...
public class LearnSearch implements Serializable {
	...
	private int studentAgePreValue;
	private int studentAgeEndValue;
	/*private String studentEXPValue[];*/
	...
	public LearnSearch(String locationValue, String lessonValue, int lessonPreValue, int lessonEndValue,
			String studentGenderValue, int studentAgePreValue, int studentAgeEndValue, int lessonPricePreValue,
		...
		this.studentGenderValue = studentGenderValue;
		this.studentAgePreValue = studentAgePreValue;
		this.studentAgeEndValue = studentAgeEndValue;
	...
	public LearnSearch(String locationValue, String lessonValue, String studentGenderValue, int studentAgePreValue,
			int studentAgeEndValue, int lessonPricePreValue, int lessonPriceEndValue, int lessonLevelPreValue,
	...
	public String getStudentGenderValue() {
		return studentGenderValue;
	}

	public void setStudentGenderValue(String studentGenderValue) {
		this.studentGenderValue = studentGenderValue;
	}

	public int getStudentAgePreValue() {
		return studentAgePreValue;
	}

	public void setStudentAgePreValue(int studentAgePreValue) {
		this.studentAgePreValue = studentAgePreValue;
	}

	public int getStudentAgeEndValue() {
		return studentAgeEndValue;
	}

	public void setStudentAgeEndValue(int studentAgeEndValue) {
		this.studentAgeEndValue = studentAgeEndValue;
	}
	...
	public String toString() {
		return "LearnSearch [locationValue=" + locationValue + ", lessonValue=" + lessonValue + ", lessonPreValue="
				+ lessonPreValue + ", lessonEndValue=" + lessonEndValue + ", studentGenderValue=" + studentGenderValue
				+ ", studentAgePreValue=" + studentAgePreValue + ", studentAgeEndValue=" + studentAgeEndValue
