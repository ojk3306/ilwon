...
/**
 * Servlet implementation class AdminSeminaList
 */
@WebServlet("/adminseminalist")
public class AdminSeminaList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminSeminaList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ArrayList<Semina> semina = new SeminaService().aSeminaList();
