...
<span class="glyphicon btn-glyphicon glyphicon-plus img-circle text-success"></span>관심등록!</a>
<br>
<a class="btn icon-btn btn-primary" href="#">
<span class="glyphicon btn-glyphicon glyphicon-thumbs-up img-circle text-primary"></span>추천합니다!</a>
</div>
