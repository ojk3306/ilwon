...
.star-input2>.input2>label[for="p2"]{ 
    width: 20px;
    z-index: 9;
}
...
.star-input2>.input2>label[for="p4"]{ 
    width: 40px;
    z-index: 7;
}
...
.star-input2>.input2>label[for="p6"]{ 
    width: 60px;
    z-index: 5;
}
...
.star-input2>.input2>label[for="p8"]{ 
    width: 80px;
    z-index: 3;
}
...
.star-input2>.input2>label[for="p10"]{ 
    width: 100px;
    z-index: 1;
}
.star-input>output,
...
<span class="star-input">
 ...
 <span class="star-input2">
  <span class="input2">
    <input type="radio" name="star-input2" id="p2" value="2"><label for="p2">2</label> 
    <input type="radio" name="star-input2" id="p4" value="4"><label for="p4">4</label>
    <input type="radio" name="star-input2" id="p6" value="6"><label for="p6">6</label>
    <input type="radio" name="star-input2" id="p8" value="8"><label for="p8">8</label>
    <input type="radio" name="star-input2" id="p10" value="10"><label for="p10">10</label>
  </span>
...
<!-- <span class="star-input">
  <span class="input">
    ...
    <input type="radio" name="star-input3" id="p6" value="6"><label for="p6">6</label>
    <input type="radio" name="star-input3" id="p8" value="8"><label for="p8">8</label>
