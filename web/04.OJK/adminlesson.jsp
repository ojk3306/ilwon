...
<%
	ArrayList<Lesson> lesson=(ArrayList<Lesson>)request.getAttribute("lesson");
...
<script>
function adminupdate(val) {
	
 location.href="/prototype/04.OJK/adminLessonUpdate.jsp?lesson=" + val;
                ...
                <table class="table table-striped table-bordered table-list">
                  ...
                  <tbody>
                	<%for(Lesson l : lesson) { %>
                		<tr>
                			<td align="center">
                         		<a class="btn btn-default" onclick="location.href='/prototype/aulessonv?no=<%=l.getLesson_no() %>'">
                            		<em class="fa fa-pencil" >
                            		</em>
                            	</a>
                  			</td>
                			<td><%=l.getLesson_title() %></td>
                			<td><%=l.getCategory_bigName() %>/<%=l.getCategory_smallName() %></td>
                			<td><%=l.getUser_name2() %></td>
                			<td><%=l.getUser_name1() %></td> <!--이메일 불러오는 겁니다-->
                			<td><%=l.getState_no() %></td>
                		</tr>
                	<%} %>
