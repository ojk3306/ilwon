    ...
    <div class="col-md-6 col-sm-12 col-lg-6 col-md-offset-3">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form action="/prototype/updatelesson.sm" method="post" enctype="multipart/form-data" id="formBy">
					<div class="form-group">
						<label for="title">배우고싶어요 수정하기</label>
						<input id="title" value="<%=le.getLesson_title()%>" name="title" class="form-control" type="text" required>
					...
					<div class="form-group">
						...
						<input id="price" name="price"  class="form-control" value="<%=le.getLesson_price() %>" type="number" min="1" style="width: 15%; float:left" required>
						 <label for="count" style="margin-left:30px;    width: 7%; float:left" >횟수:</label>
						<input id="count" name="count"  class="form-control" value="<%=le.getLesson_count() %>" type="number" min="1" style="width: 15%; float:left" required>
					...
					<div class="form-group">
						...
						<textarea name="contop" id="contop" rows="10" cols="68pt" required>
						<%=le.getLesson_contop() %>
						</textarea>
					...
					<div class="form-group">
						...
						<input type="text" value="<%=le.getLesson_loc()%>" id="loc" name="loc" class="form-control" onclick="juso()" readonly="readonly" placeholder="클릭 해서 지역을 선택해주세요!">
						<span id="locl" class="text-danger"></span>
					</div>
					
					<div class="form-group">
					<label for="rad">가능 반경(단위/미터)</label>
					<input type="number" name="rad" id="rad" min="1000" class="form-control" value="<%=le.getLesson_rad()  %>" style="width: 100px; margin-bottom: 10px;" required>
					...
					<input type="hidden" name="conbot" value="<%= le.getLesson_conbot() %>">
					<input type="hidden" name="conmid" value="<%= le.getLesson_conmid() %>">
					<input type="hidden" name="leno" value="<%= le.getLesson_no() %>">
					<input type="hidden" name="keyword" value=".">
					
					<center>
					
					<input type="button" value="배움란수정" class="btn btn-primary center" onclick="return check()">
